...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org-roam-ui company zoom-window zenburn-theme yaml-mode whole-line-or-region use-package undo-tree smartparens org-superstar nlinum neotree markdown-mode ledger-mode htmlize expand-region exec-path-from-shell elisp-slime-nav dired-subtree company-ycmd ace-window))
